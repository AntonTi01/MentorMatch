...
# Выполняет POST-запрос к сервису сопоставления с заданным телом
...
# Запрашивает пересчет векторного профиля студента
...
# Запрашивает пересчет векторного профиля наставника
